 ...
 * @author grs
 */
public class BlogMonitorXpathExtractor extends XpathExtractor<BlogData> implements BlogMonitorExtractorAttribute {
	@Override
	...
	public String templateContentPage(BlogData data, HtmlInfo html, int page,
		...
		String title = result.getTitle()==null?data.getTitle():result.getTitle();
		//标题需要处理
		//搜索词里面带有特殊符号的情况
		boolean spe = false;
