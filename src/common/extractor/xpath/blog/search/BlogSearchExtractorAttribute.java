...
public interface BlogSearchExtractorAttribute extends ExtractorAttribute<BlogData> {
	 ...
	 * @param content
	 */
	public void parseAuthor(List<BlogData> list, Node domtree, Component component, String... content);
}
