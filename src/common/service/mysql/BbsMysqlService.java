...
public class BbsMysqlService extends MysqlService<BBSData> {

	private static final String COMM = "bbs_comment";
	private static final String DATA = "bbs_data";
	
	private static final String csql = "insert into "+COMM+"(" +
			"md5," +
			"name," +
			"pubtime," +
			"insert_time," +
	...
	private static final String vsql = "insert into "+DATA+"(" +
			"url, " +
			"md5," +
			"title," +
			"author," +
...
//		if(findId(vd.getMd5(), DATA)>0) return;
		...
		this.jdbcTemplate.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(Connection con)
				...
				ps.setObject(13, vd.getInserttime());
	...
	public void saveCommonData(BBSData data) {
